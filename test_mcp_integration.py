...
def test_mcp_integration():
    ...
    with tempfile.TemporaryDirectory(prefix="apex_test_") as temp_dir:
        ...
        try:
            ...
            print(f"   MCP config created: {'✅ Yes' if mcp_config_exists else '❌ No'}")
            ...
            if mcp_config_exists:
                ...
                print(f"   APEX LMDB server configured: {'✅ Yes' if has_apex_server else '❌ No'}")
        ...
        try:
            ...
            for agent_type in AgentType:
                ...
                if claude_available:
                    ...
                    print(f"   🔧 {agent_type.value} command: {' '.join(command[:3])}...")
